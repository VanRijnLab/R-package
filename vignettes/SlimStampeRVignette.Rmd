...
You may run into warning or error messages when you run the code. At the end of this vignette is a section with common warning and error messages and their solutions.
...
If you don't know what your current directory is, you can check this by entering `getwd()` in the console.
...
If you want to use the default save option you can just leave the parameter 'filepath' out of the function call.
...
There is also the option to print only one session:
